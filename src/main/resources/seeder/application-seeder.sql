...
INSERT INTO applications(id, first_name, mid_name, last_name, street, street2, city, state, zip,record_relationship, purpose, record_type, form_type, contact_type, identification_img, form_img, comments,comment_date_time, record_id, user_id, status_id)
VALUES (1, 'sarah', null, 'barron', '2222 cavalier ave', null, 'san antonio', 'tx', '78210', 'daughter','funeral', 'death', 'long', 'phone', null, null, 'e',current_date, 1, 1, 100);
